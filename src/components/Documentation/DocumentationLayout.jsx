...
import { FiMenu, FiX, FiChevronDown, FiChevronRight, FiHome } from 'react-icons/fi';

const DocumentationLayout = ({ menuItems }) => {
  ...
  useEffect(() => {
    ...
    menuItems.forEach(section => {
      initialExpanded[section.id] = location.pathname.startsWith(`/learn/${section.id}`);
    });
        ...
        >
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <Link to="/" className="flex items-center space-x-2 text-gray-800 hover:text-indigo-600">
